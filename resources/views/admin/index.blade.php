...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sign In | Jibika - Admin Panel</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Jibika Admin Panel" name="description" />
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Get your admin panel now</p>
                                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Jibika. Crafted with <i class="mdi mdi-heart text-danger"></i> by <a href="https://www.royinformatics.com/" target="_blank">Roy Informatics Pvt Ltd</a>
                            </p>
                        </div>
                    </div>
                </div>
