...
@php
    $city_result=DB::table('cities')->where('id',$user_result->city)->first();
@endphp
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            ...
                                            <input type="hidden" name="user_id" class="form-control" value="{{$user_result->id}}">
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            <label for="placeholderInput" class="form-label">Email</label>
                                            <input type="email" class="form-control" value="{{$user_result->email}}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            <label for="placeholderInput" class="form-label">Phone</label>
                                            <input type="tel" class="form-control" value="{{$user_result->phone}}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                    ...
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            ...
                                            <select class="form-control" name="active_status" required>
                                                <option value="YES" {{$user_result->active_status=='YES'?'selected':''}} >YES</option>
                                                <option value="NO" {{$user_result->active_status=='NO'?'selected':''}} >NO</option>
                                            </select>
                                        </div>
                                    </div>
