                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Update FAQ</h4>
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-12 col-md-12">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" name="question" placeholder="Question" value="{{$faq->question}}" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-12 col-md-12">
                                        <div>
                                            <label for="exampleFormControlTextarea5" class="form-label">Answer*</label>
                                            <textarea class="form-control" id="exampleFormControlTextarea5" name="answer" rows="3" placeholder="Write Something.." required>{{$faq->answer}}</textarea>
                                        </div>
                                    </div>
