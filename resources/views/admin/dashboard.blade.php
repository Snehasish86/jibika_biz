...
@php
    ...
    $free_ads=DB::table('ads')->where('package',1)->count();
    $total_ads=DB::table('ads')->count();
    $premium_ads=$total_ads-$free_ads;
@endphp
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        ...
                                                        <a href="{{ url('/admin/users') }}"><p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> View</span></p></a>
                                                    </div>
                                                    <div>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        ...
                                                        <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="{{  $total_contact }}">{{  $total_contact }}</span></h2>
                                                        <a href="{{ url('/admin/contacts') }}"><p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> View</span></p></a>
                                                    </div>
                                                    <div>
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <span class="avatar-title bg-soft-info rounded-circle fs-2">
                                    ...
                                    <div class="col-md-3">
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        <p class="fw-medium text-muted mb-0">Free Ads</p>
                                                        <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="{{ $free_ads }}">{{ $free_ads }}</span></h2>
                                                        <a href="{{ url('/admin/ads') }}"><p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> View</span></p></a>
                                                    </div>
                                                    <div>
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <span class="avatar-title bg-soft-info rounded-circle fs-2">
                                    ...
                                    <div class="col-md-3">
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        <p class="fw-medium text-muted mb-0">Premium Ads</p>
                                                        <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="{{ $premium_ads }}">{{ $premium_ads }}</span></h2>
                                                        <a href="{{ url('/admin/ads') }}"><p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> View</span></p></a>
                                                    </div>
                                                    <div>
                                                        <div class="avatar-sm flex-shrink-0">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Pending Ads List (Waiting for approval) </h5>
                        ...
                        <div class="card-body">
                            <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    @php
                                    $row=DB::table('ads')->where('active_status','NO')->orderBy('id','desc')->get();
                                    @endphp
                                    @foreach ($row as $details)
                                        ...
                                        <tr>
                                            ...
                                            <form action="{{url('/admin/deleteAds2')}}" method="post" id="delete_submit{{$details->id}}" style="display:none;">
                                                        {{csrf_field()}}
