                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Category List <a href="{{ url('/admin/category/create') }}"><button class="btn btn-primary">Add+</button></a></h5>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($category as $details)
                                        ...
                                        <tr>
                                            ...
                                            <form action="{{url('/admin/category/'.$details->id)}}" method="post" id="delete_submit{{$details->id}}" style="display:none;">
                                                    {{ method_field('DELETE') }}
                                                        {{csrf_field()}}
