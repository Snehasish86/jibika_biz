                            ...
                            <div class="live-preview">
                                ...
                                <div class="row gy-4">
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            <label for="placeholderInput" class="form-label">City Name*</label>
                                            <input type="text" class="form-control" name="city" placeholder="City Name" value="{{$city->city}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row gy-4">  
                                  <div class="row gy-4 mt-2">
                                    <div class="col-xxl-3 col-md-12">
                                        <div>
                                            ...
                                            <textarea id="editor" name="seo_content">{{$city->seo_content}}</textarea>
                                        </div>
                                    </div>
                                   </div>
                                </div>
