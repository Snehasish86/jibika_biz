                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Update Subcategory</h4>
                                ...
                                <div class="row gy-4">
                                        ...
                                        <div>
                                            ...
                                            <select class="form-control" name="cat_id" required>
                                                ...
                                                @foreach ($category as $details)
                                                        <option value="{{$details->id}}" {{$subcategory->cat_id==$details->id?'selected':''}} >{{$details->category}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" name="subcategory" placeholder="Subcategory Name" value="{{$subcategory->subcategory}}" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            ...
                                            <input type="hidden" class="form-control" name="previous_image" value="{{ $subcategory->image }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xxl-3 col-md-12">
                                        <div>
                                            ...
                                            <textarea id="editor" name="seo_content">{{$subcategory->seo_content}}</textarea>
                                        </div>
                                    </div>
                                </div>
