...
<title>Ad Report | Jibika - Free classifieds in India, Buy and Sell for free anywhere in India with Jibika Online Classified Advertising</title>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-3 col-md-4 pl-lg-0">
                    <div class="couter details-right-top">
                        ...
                        <div id="reporting-div" class="anything-wrong listing-category details-sidebar" style="display:block;">
                             @if(session()->has('success'))
                                <div class="alert alert-secondary alert-dismissible alert-solid alert-label-icon fade show" role="alert">
                                    <i class="ri-check-double-line label-icon"></i>{{ session()->get('success') }}
                                </div>
                            @endif
                            <span class="text-left">Anything Wrong ? Report this ad.</span>
                            <!--<a href="#"><i id="close-flagged-form" class="fa fa-times float-right"-->
                            <!--        aria-hidden="true"></i></a>-->
                                    <form method="POST" action="{{ url('/submit_adreport') }}">
                                        @csrf
