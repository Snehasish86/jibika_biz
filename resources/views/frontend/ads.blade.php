...
<title>Ads | Jibika - Free classifieds in India, Buy and Sell for free anywhere in India with Jibika Online Classified Advertising</title>
...
$package_details=DB::table('packages')->where('keyword',$package_keyword)->first();
@endphp
<!-- banner -->
...
<div class="text-center">
  <h1 class="title">{{ $package_details->title }} ADS</h1>
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
      <li class="breadcrumb-item active" aria-current="page">{{ $package_details->title }} ADS</li>
    </ol>
  </nav>
</div>
<!-- Column --> 
...
<section class="top_listings pb-4">
  ...
  <div class="row justify-content-center">
    <div class="col-md-7 text-center">
      <h2 class="title">{{ $package_details->title }} ADS</h2>
    </div>
  </div>
  <!-- Row  -->
  {{-- <div class="row">
  ...
  <div class="row">
      ...
      $highlight_row=DB::table('ads')
                        ->where('package',$package_details->id)
