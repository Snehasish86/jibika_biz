...
<title>Dashboard | Jibika - Free classifieds in India, Buy and Sell for free anywhere in India with Jibika Online Classified Advertising</title>
          ...
          @endif
              ...
              <div class="table">
                <table class="table table-xl mb-0 table-responsive">
                  ...
                  <tbody>
                    @php
                    $urgent_row=DB::table('ads')->where('user_id',Auth::guard('user')->user()->id)->where('active_status','YES')->orderBy('id','desc')->get();
                    $userad_count=DB::table('ads')->where('user_id',Auth::guard('user')->user()->id)->where('active_status','YES')->orderBy('id','desc')->count();
                    @endphp
